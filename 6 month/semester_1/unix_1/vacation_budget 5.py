...
# === File Operations ===
write_summary_to_file("budget_summary.txt", summary)

log_entry = (
    f"Income: ${income:.2f} | Budget: ${trip_budget:.2f} | "
    f"Expenses: ${total_expenses:.2f} | Savings: ${savings:.2f}"
)
append_log_to_file("budget_log.txt", log_entry)

print("✅ Summary written to 'budget_summary.txt'")
print("📒 Log updated in 'budget_log.txt'")
